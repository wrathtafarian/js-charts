...
**js-charts** supports <ins>37 unique charts</ins> that are divided into <ins>18 chart types</ins>.

> 💡 Watch this page - we are constantly adding new charts.

## 📚 Table of Contents

 1. [📊 Bar Charts](#-bar-charts)
 1. [📦 Box-and-Whisker Plots (Box Plots)](#-box-and-whisker-plot-box-plots)
 1. [🎈 Bubble Charts](#-bubble-charts)
 1. [📊 Column Charts](#-column-charts)
 1. [🔻 Funnel Charts](#-funnel-charts)
 1. [🌡️ Heatmaps](#️-heatmaps)
 1. [⏳ Histograms](#-histograms)
 1. [📈 Line Charts](#-line-charts)
 1. [🍭 Lollipop Charts](#-lollipop-charts)
 1. [📊 Marimekko Charts](#-marimekko-charts)
 1. [📉 Parallel Coordinates Plots](#-parallel-coordinates-plots)
 1. [🍩 Pie & Doughnut Charts](#-pie--doughnut-charts)
 1. [🧑‍🤝‍🧑 Population Pyramids](#-population-pyramids)
...
💡 Refer to the [📊 Bar Charts](/wiki/charts/Bar%20Charts.md) page for detailed information about **bar charts**.

## 📦 Box-and-Whisker Plots (Box Plots)

 - **Usage**: 🧵 Patterns 🔍 Comparison ↔️ Distribution 🌡️ Range
...
💡 Refer to the [📦 Box Plots](/wiki/charts/Box%20Plots.md) page for detailed information about **box-and-whisker plots** (or **box plots**).

## 🎈 Bubble Charts

 - **Usage**: 🧵 Patterns 🔍 Comparison ↔️ Distribution  ⏱️ Date-Over-Time  ⚖️ Proportions  🆚 Relationship
...
💡 Refer to the [🎈 Bubble Charts](/wiki/charts/Bubble%20Charts.md) page for detailed information about **bubble charts**.
...
💡 Refer to the [📊 Column Charts](/wiki/charts/Column%20Charts.md) page for detailed information about **column charts**.
...
💡 Refer to the [🔻 Funnel Charts](/wiki/charts/Funnel%20Charts.md) page for detailed information about **funnel charts**.
...
💡 Refer to the [🌡️ Heatmaps](/wiki/charts/Heatmaps.md) page for detailed information about **heatmaps**.
...
💡 Refer to the [⏳ Histograms](/wiki/charts/Histograms.md) page for detailed information about **histograms**.

## 📈 Line Charts

 - **Usage**: ⏱️ Date-Over-Time 🧵 Pattern 🔍 Comparison
...
💡 Refer to the [📈 Line Charts](/wiki/charts/Line%20Charts.md) page for detailed information about **line charts**.
...
💡 Refer to the [🍭 Lollipop Charts](/wiki/charts/Lollipop%20Charts.md) page for detailed information about **lollipop charts**.

## 📊 Mekko (Marimekko) Charts

 - **Usage**: 🔍 Comparison 🆚 Relationship 🥧 Part-To-A-Whole ⚖️ Proportions
...
💡 Refer to the [📊 Mekko (Marimekko) Charts](/wiki/charts/Mekko%20Charts.md) page for detailed information about **mekko (marimekko) charts**.
...
💡 Refer to the [📉 Parallel Coordinates Plots](/wiki/charts/Parallel%20Coordinates.md) page for detailed information about **parallel coordinates charts**.
...
💡 Refer to the [🍩 Pie & Doughnut Charts](/wiki/charts/Pie%20and%20Doughnut%20Charts.md) page for detailed information about **pie & doughnut charts**.
...
💡 Refer to the [🧑‍🤝‍🧑 Population Pyramids](/wiki/charts/Population%20Pyramid.md) page for detailed information about **population pyramids**.
...
💡 Refer to the [🎯 Scatter Plots](/wiki/charts/Scatter%20Plots.md) page for detailed information about **scatter charts** (or **scatter plots**).
...
💡 Refer to the [📏 Span Charts](/wiki/charts/Span%20Charts.md) page for detailed information about **span charts**.
...
💡 Refer to the [💲 Stock Charts](/wiki/charts/Stock%20Charts.md) page for detailed information about **stock charts**.
...
💡 Refer to the [🌲 Treemaps](/wiki/charts/Treemaps.md) page for detailed information about **treemaps**.
...
💡 Refer to the [🌊 Waterfall Charts](/wiki/charts/Waterfall%20Charts.md) page for detailed information about **waterfall charts**.